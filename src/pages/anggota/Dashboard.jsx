...
export default function Dashboard () {
  return(
    ...
    <div className="flex justify-center items-center gap-7 p-20">
      ...
      <p className="text-xl">Mewujudkan masyarakat Humbang Hasundutan yang cerdas, mandiri, dan bermartabat melalui optimalisasi budaya baca dan pengelolaan kearsipan yang profesional.</p>
      <div className="font-bold text-2xl"><h2>Misi:</h2></div>
      <div className="">
      <p className="text-xl">​1. Peningkatkan Minat Baca: Menumbuhkan kebiasaan membaca di seluruh lapisan masyarakat, mulai dari tingkat desa hingga perkotaan.<br></br>​2. Penyediaan Koleksi yang Berkualitas: Menyediakan buku dan referensi (baik fisik maupun digital) yang relevan dengan kebutuhan masyarakat petani, pelajar, dan umum di Humbang Hasundutan.
      ...
      <p className="text-xl">@disperpusiphumbahas</p>
      </div>
    </div>
    </div>
  );
